...
class CourseDetailActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btnSave.setOnClickListener {
            ...
            c.credits = spinnerCredits.selectedItem as Int
            ...
            if (mode == "add") {
                repo.createCourse(c) { result ->
                    runOnUiThread {
                        result.onSuccess { id -> Toast.makeText(this, "Course added", Toast.LENGTH_SHORT).show(); finish() }
            ...
            btnSave.setOnLongClickListener {
                AlertDialog.Builder(this)
                    ...
                    .setPositiveButton("Delete") { _, _ ->
                        course?.let { repo.deleteCourse(it.id) { res -> runOnUiThread { res.onSuccess { Toast.makeText(this, "Deleted", Toast.LENGTH_SHORT).show(); finish() } ; res.onFailure { e -> Toast.makeText(this, "Delete failed: ${e.message}", Toast.LENGTH_SHORT).show() } } } }
